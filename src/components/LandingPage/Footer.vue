    ...
    <div class="container flex flex-col md:flex-row items-center">
      <div class="flex flex-1 flex-wrap items-center justidy-center md:justify-start gap-12">
        ...
        <ul class="flex text-white uppercase gap-12 text-xs">
          ...
          <li class="cursor-pointer">邱語謙</li>
          <li class="cursor-pointer">陸翊涔</li>
          <li class="cursor-pointer">李懿恩</li>
          <li class="cursor-pointer">林品歷</li>
          <li class="cursor-pointer">吳品萱</li>
        </ul>
      </div>
    </div>
  </footer>
